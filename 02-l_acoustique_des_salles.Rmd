...
La plupart des pièces d'habitations sont des salles "rectangulaire". Dans ce cas, les surfaces sont toutes parallèles. Ce type de salle est particulièrement propice à l'apparition d'ondes stationnaires.
...
$$f(n) = \frac{c}{2L}.n$$
où $c=340\,m.s^{-1}$, $L$ est la longueur considérée de la pièce. Pour $n=0$ on trouve le **mode propre**. Pour $n>0$ on trouvera tous les **modes harmoniques**.
