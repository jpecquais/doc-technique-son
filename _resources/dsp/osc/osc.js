...
Compilation options: -lang wasm -cn osc -es 1 -mcd 16 -single -ftz 2 
*/

function getJSONosc() {
	return '{"name": "osc","filename": "osc.dsp","version": "2.49.1","compile_options": "-lang wasm -cn osc -es 1 -mcd 16 -single -ftz 2","include_pathnames": ["/usr/local/share/faust","/usr/local/share/faust","/usr/share/faust",".","/tmp/sessions/ACBBB21591E4B4F023E6B31B4310380CB9847DA7/web/wasmjs"],"size": 262200,"inputs": 0,"outputs": 1,"meta": [ { "author": "Grame" },{ "basics_lib_name": "Faust Basic Element Library" },{ "basics_lib_version": "0.8" },{ "compile_options": "-single -scal -I libraries/ -I project/ -lang wasm" },{ "copyright": "(c)GRAME 2009" },{ "filename": "osc.dsp" },{ "library_path0": "/libraries/stdfaust.lib" },{ "library_path1": "/libraries/oscillators.lib" },{ "library_path2": "/libraries/platform.lib" },{ "library_path3": "/libraries/maths.lib" },{ "library_path4": "/libraries/basics.lib" },{ "library_path5": "/libraries/signals.lib" },{ "license": "BSD" },{ "maths_lib_author": "GRAME" },{ "maths_lib_copyright": "GRAME" },{ "maths_lib_license": "LGPL with exception" },{ "maths_lib_name": "Faust Math Library" },{ "maths_lib_version": "2.5" },{ "name": "osc" },{ "oscillators_lib_name": "Faust Oscillator Library" },{ "oscillators_lib_version": "0.3" },{ "platform_lib_name": "Generic Platform Library" },{ "platform_lib_version": "0.2" },{ "signals_lib_name": "Faust Signal Routing Library" },{ "signals_lib_version": "0.3" },{ "version": "2.52.3" }],"ui": [ {"type": "vgroup","label": "Oscillator","items": [ {"type": "hslider","label": "freq","shortname": "freq","address": "/Oscillator/freq","index": 262144,"meta": [{ "scale": "log" },{ "unit": "Hz" }],"init": 1000,"min": 20,"max": 24000,"step": 1},{"type": "hslider","label": "volume","shortname": "volume","address": "/Oscillator/volume","index": 262172,"meta": [{ "unit": "dB" }],"init": -20,"min": -96,"max": 0,"step": 0.1}]}]}';
}
/*
 faust2webaudio
