...
```{r, echo=FALSE, out.width="100%", fig.cap = "Représentation d'un son pur : temps en absisses, amplitude en ordonnée"}
knitr::include_graphics(path = "_resources/sinus_tps.svg")
```

```{r, echo=FALSE, out.width="100%", fig.cap = "Représentation d'un son pur : fréquences en absisses, amplitude en ordonnée"}
knitr::include_graphics(path = "_resources/sinus_fqc.svg")
```
