...
Lorsque le terme $\gamma$ augmente (typiquement égal à deux), on améliore la direction du vecteur énergie $r_E$ (au final, le vecteur $r_V$ du VBAP est égal au vect $r_E$ du VBIP). Cela signifie que la zone du panoramique ou les deux enceintes participent à la restitution du signal de façon significative est réduite. On considère également que la localisation des fréquences aiguës (supérieurs à 700 Hz) est améliorée. 


### le VBAP {#sec-vbap}

Le VBAP (pour *Vector Based Amplitude Panning*) apparait pour la première dans le papier [*Virtual Sound Source Positioning Using Vector Base
Amplitude Panning*](http://lib.tkk.fi/Diss/2001/isbn9512255324/article1.pdf) publié en 1997 à journal de l'AES par [Ville Pulkki](https://en.wikipedia.org/wiki/Ville_Topias_Pulkki).
