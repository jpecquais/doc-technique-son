...
show_fig(rep("_resources/drawings/reverb.svg"))
```
...
if (knitr:::is_latex_output()) {
  knitr::asis_output('\\url{_resources/gif/Standing_wave_2.gif}')
} else {
  knitr::include_graphics(rep("_resources/gif/Standing_wave_2.gif"))
}
...
```{python, echo=FALSE, fig.align="center", fig.caption="Filtre en peigne correspondant à un retard d'une milliseconde", warning=FALSE, message=FALSE}
...
show_fig(rep("_resources/drawings/roomPr.svg"))
```
