# Les modulations de signaux numériques
...
```{python, echo=FALSE, fig.align="center", fig.cap="Exemples de signaux carrés (Non Return to Zero à gauche, Return to Zero à droite)", out.width="100%"}
...
axs[0].plot(t, square1)
var = axs[0].set_xlim(0,0.004)
#axs[0].set_xlabel("Temps (s))")
axs[0].set_ylabel("Amplitude")
axs[0].legend()

axs[1].plot(t, square2)
var = axs[1].set_xlim(0,0.004)
var = 0
...
```{r, echo = FALSE, fig.align='center', fig.cap="Câble Toslink", out.width="30%"}
knitr::include_graphics("_resources/bitmap/plug/toslink.jpg")
```
...
```{r, echo = FALSE, fig.align='center', fig.cap="Fibre optique et câble BNC", fig.show="hold", out.width="30%"}
knitr::include_graphics("_resources/bitmap/plug/fibre.jpg")
knitr::include_graphics("_resources/bitmap/plug/bnc.jpg")
```
