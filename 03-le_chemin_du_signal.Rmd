# (PART) Équipement et usage {-}

<!--
    Définir analogue, transducteur, numérique, informatique
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap = "Le chemin du signal. Elle peut-être agrandie en ouvrant l'image dans un nouvel onglet."}
