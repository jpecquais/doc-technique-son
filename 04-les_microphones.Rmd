...
+ Ce sont, historiquement, les premiers microphones à permettre une captation satisfaisante du son (réponse en fréquence). Mais à leurs débuts, ils sont très sensibles aux conditions de température et d’humidité. Ces problèmes n’ont plus cours aujourd’hui.
+ Le fonctionnement repose sur l’utilisation d’un condensateur en guise de capsule. Lorsque le son rencontre cette dernière, l’onde déforme les armatures du condensateur et génère donc une variation de tension.
+ De par l’utilisation de condensateur, ces microphones nécessitent une alimentation externe (dites fantôme), maintenant standardisée à +48V.
+ Ces microphones possèdent des réponses en fréquence souvent très linéaire et une excellente réponse en transitoire.
+ Leur niveau de sortie (sensibilité) est élevé.
+ Leur impédance de sortie est basse.
