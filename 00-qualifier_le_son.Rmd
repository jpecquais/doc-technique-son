...
```{python, echo=FALSE, fig.align="center", fig.cap="Signal carré et visualisation de son spectre"}
import matplotlib.pyplot as plt
import numpy as np
...
show_fig("_resources/drawings/adsr.svg")
```
...
show_fig("_resources/drawings/mic_dist.svg")
```
...
show_fig("_resources/drawings/spectre.svg")
```
...
```{r, echo = FALSE, fig.align="center", fig.cap = "Courbes d'isosonie, aussi dites de Fletcher-Munson", out.width="100%"}
knitr::include_graphics("_resources/diagrams/Courbes_isosonie.png")
```
...
show_fig("_resources/drawings/delta_t.svg")
```
